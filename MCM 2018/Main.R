...
change_languages_2070[,3:17] = as.numeric(change_languages_2020[,3:17]) + as.numeric(change_languages_2030[,3:17]) +
  as.numeric(change_languages_2040[,3:17]) + as.numeric(change_languages_2050[,3:17]) +
  as.numeric(change_languages_2060[,3:17]) + as.numeric(change_languages_2070[,3:17])
...
Scale = as.numeric(Scale$Scale.Rate)

for(i in length(Scale)){
  initial_population[,i] = initial_population[,i] * Scale[i]
}
...
for(i in length(Scale)){
  population2030[,i] = population2030[,i] * Scale[i]
}
...
for(i in length(Scale)){
  population2040[,i] = population2040[,i] * Scale[i]
}
...
for(i in length(Scale)){
  population2050[,i] = population2050[,i] * Scale[i]
}
...
for(i in length(Scale)){
  population2060[,i] = population2060[,i] * Scale[i]
}
...
for(i in length(Scale)){
  final_population[,i] = final_population[,i] * Scale[i]
}
...
Adjusted_Population =read.csv("Adjusted.csv",header=F)
Adjusted_Population = as.matrix(Adjusted_Population)
rownames(Adjusted_Population) = c(2020,2030,2040,2050,2060,2070)
colnames(Adjusted_Population) = languages_used
